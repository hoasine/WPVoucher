pageextension 70017 wpPosDataEntryExt extends "LSC POS Data Entries"
{
    layout
    {
        addlast(Control1)
    ...
    local procedure GetDisplayStatus(): Text[30]
    var
        dataEntry: Record "LSC POS Data Entry Type";
    begin
        Clear(dataEntry);
        dataEntry.SetRange(Code, REC."Entry Type");
        dataEntry.SetRange("Enable/ Activate Taka Voucher", true);
